...
int main( void ){
   ...
   bool inactY = 0;
   bool inactZ = 0;
   bool act_inact_tot[] = {act_ac_dc, actX, actY, actZ, inact_ac_dc, inactX, inactY, inactZ};
   ...
   bool watermark = 0;
   bool overrun = 0;
   bool interrupts[] = {overrun, watermark, freefall, inactivity, activity, double_tap, single_tap, data_ready};
